 ...
 * séries, as disciplinas e as turmas (8.0). O vínculo entra na 9.0.
 */
@Module({
  controllers: [EscolaSessaoController, AnoLetivoController, SerieController, DisciplinaController, TurmaController],
  providers: [
