...
- [ ] 2.1 — Migration de `ano_letivo`, `conta`, `usuario`, `sessao` e `registro_acesso`, conforme a seção 3
...
- [ ] 2.2 — `EmissorDeToken` e as três guardas em `packages/nucleo/src/identidade`
...
- [ ] 2.3 — `MATRIZ` em `packages/shared/src/permissao/matriz.ts`
...
- [ ] 2.4 — `ResolucaoDeTenantRepository` em `apps/api/src/sessao`
...
- [ ] 2.5 — Varredura de DTO e `ops:sessao-sintetica`
