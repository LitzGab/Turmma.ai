...
- [ ] 12.1 — Serviço `observabilidade` com `grafana/otel-lgtm` no compose e
...
- [ ] 12.3 — Painel provisionado por arquivo em `infra/grafana/paineis/`
- [ ] 12.4 — Testes consultando a API de métricas do otel-lgtm (Prometheus/Mimir). Captura
  de tela não conta
