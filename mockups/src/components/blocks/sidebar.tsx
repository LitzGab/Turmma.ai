...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button relative flex w-full items-center gap-2.5 overflow-hidden rounded-linha px-2.5 text-left text-sm text-tinta outline-none transition-[background-color,color] duration-150 ease-estado hover:bg-sidebar-accent active:bg-sidebar-accent disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[state=open]:hover:bg-sidebar-accent group-data-[collapsible=icon]:!size-10 group-data-[collapsible=icon]:!justify-center group-data-[collapsible=icon]:!px-0 [&>span:last-child]:truncate [&>svg]:size-[18px] [&>svg]:shrink-0",
  {
    variants: {
      variant: {
